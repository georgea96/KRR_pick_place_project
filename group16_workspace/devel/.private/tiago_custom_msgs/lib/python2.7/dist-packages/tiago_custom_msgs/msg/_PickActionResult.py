...
"""autogenerated by genpy from tiago_custom_msgs/PickActionResult.msg. Do not edit."""
import codecs
import sys
...
class PickActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "tiago_custom_msgs/PickActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tiago_custom_msgs/PickResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PickActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = tiago_custom_msgs.msg.PickResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = tiago_custom_msgs.msg.PickResult()
